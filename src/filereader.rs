...
pub mod filereader {
    ...
    use std::io::prelude::*;
    use crate::structs::RoverMap;
    use crate::structs::Point;
    use crate::structs::RoverMetadata;
...
#[doc = r"Read all rover map data from a file. The format is as follows:
    ...
    * Line 5+n onwards: The matrix of elevations of the map"]
    pub fn load_map_data_from_file(path: &str) -> (RoverMetadata, RoverMap) {
        ...
        let landing_point = Point::new_point(landing_x, landing_y);
        ...
        // Read line 6 - 5+n
        let mut target_sites : Vec<Point> = Vec::new();
        for i in 0..num_targets {
            ...
            let target_site = Point::new_point(landing_x, landing_y);
        ...
        let rover_map = RoverMap::generate(width, height, landing_point, target_sites, elevations);
        let rover_meta = RoverMetadata::generate(algorithm, max_rover_delta_height);
